...
namespace ConsoleApp1
{
    class Arrays
    {
        ...
        */
        ...
        //printUniquePairsUsingHashtable(new int[] { 2, 4, 7, 5, 9, 10, -1 }, 9);  
        public static string printUniquePairsUsingHashtable(int[] array, int sum)
        {
            StringBuilder sb = new StringBuilder();

            HashSet<int> hashSet = new HashSet<int>();
            foreach (int firstNumInPair in array)
            {
                ...
                else
                {
                    ...
                    {
                        sb.AppendFormat("{0},{1}<br />", firstNumInPair, secondNumInPair);
                    }
                }
            }
            return sb.ToString(); 
